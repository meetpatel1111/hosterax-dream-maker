...
const s = (
  ...
  rootMarkers,
  deps = [],
) => [id, { id, name, language, category, icon, port, build, start, outputDir, rootMarkers, deps }];
...
export const EXTRA_STACKS = Object.fromEntries([
  ...
  s(
    ...
    "dist",
    ["vite.config.ts"],
    ["@builder.io/qwik-city", "@builder.io/qwik"],
  ),
  s(
    "redwood",
    "RedwoodJS",
  ...
  s(
    ...
    "docs/.vitepress/dist",
    ["docs/.vitepress/config.ts", "package.json"],
    ["vitepress"],
  ),
  s(
    "nuxt-content",
  ...
  s(
    ...
    "strapi start",
    "build",
    ["config/server.js", "config/server.ts", "package.json"],
    ["@strapi/strapi"],
  ),
  s(
    "payload",
    ...
    "node dist/server.js",
    "dist",
    ["payload.config.ts", "payload.config.js"],
    ["payload"],
  ),
  s(
    "keystone",
  ...
  s(
    ...
    "deno task start",
    "_fresh",
    ["fresh.config.ts", "deno.json", "deno.jsonc"],
    ["$fresh"],
  ),
  s(
    "deno",
  ...
  s(
    ...
    "bun run index.ts",
    "dist",
    ["bunfig.toml", "bun.lockb", "bun.lock"],
    [],
  ),
  s(
    "electron",
  ...
  s(
    ...
    "build/libs",
    ["micronaut-cli.yml", "build.gradle", "pom.xml"],
    ["io.micronaut:micronaut-core", "micronaut-http-server-netty"],
  ),
  s(
    "vertx",
    "Eclipse Vert.x",
    ...
    ["io.vertx:vertx-core", "vertx-core"],
  ),
  s(
    "dropwizard",
    "Dropwizard",
    ...
    8080,
    "./mvnw package",
    "java -jar target/app.jar server config.yml",
    "target",
    ["pom.xml"],
    ["io.dropwizard:dropwizard-core", "dropwizard-core"],
  ),
  s(
    "ktor",
    "Ktor",
    ...
    ["io.ktor:ktor-server-core", "ktor-server-core"],
  ),
  s(
    "play",
    "Play Framework",
    ...
    "target/universal",
    ["build.sbt", "conf/application.conf"],
    ["play"],
  ),
  s(
    "scala",
  ...
  s(
    ...
    ".build/release/App serve --hostname 0.0.0.0",
    ".build/release",
    ["Package.swift"],
    ["vapor"],
  ),
  ...
  s(
    ...
    "🎯",
    8080,
    "dart pub get && dart compile exe bin/server.dart -o server",
    "./server",
    "bin",
    ["pubspec.yaml"],
    ["shelf"],
  ...
  s(
    ...
    "💎",
    3000,
    "shards install && crystal build --release src/app.cr",
    "./app",
    "bin",
    ["shard.yml"],
    [],
  ...
  s(
    ...
    5000,
    "cpanm --installdeps .",
    "plackup -o 0.0.0.0 -p 5000 app.psgi",
    null,
    ["cpanfile", "app.psgi"],
    [],
  ),
