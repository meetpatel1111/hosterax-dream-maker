...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      deploy_phase: "queued" | "building" | "deploying" | "ready" | "failed" | "cancelled";
      deploy_target: "docker" | "process" | "ssh" | "cloud";
      deploy_trigger: "git" | "manual" | "upload" | "url" | "cli" | "api" | "rollback";
      deployment_status: "queued" | "building" | "deploying" | "success" | "failed" | "cancelled";
      env_scope: "production" | "preview" | "development";
      log_level: "info" | "warn" | "error" | "success" | "debug";
      oauth_grant_type: "authorization_code" | "refresh_token" | "client_credentials";
