...
import { LayoutGrid, Rocket, Database, Activity, Settings, LogOut, Plus, Terminal, KeyRound, ShieldCheck, Cpu } from "lucide-react";
...
const NAV = [
  ...
  { to: "/local", label: "Local engine", icon: Cpu },
