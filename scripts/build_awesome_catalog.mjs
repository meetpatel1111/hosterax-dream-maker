...
const CANONICAL_TAGS = [
  ...
  { label: "Archiving and Digital Preservation (DP)", slug: "archiving-and-digital-preservation-dp", icon: "🏛️" },
  ...
  { label: "Communication - Custom Communication Systems", slug: "communication---custom-communication-systems", icon: "💬" },
  { label: "Communication - Email - Complete Solutions", slug: "communication---email---complete-solutions", icon: "✉️" },
  { label: "Communication - Email - Mail Delivery Agents", slug: "communication---email---mail-delivery-agents", icon: "📬" },
  { label: "Communication - Email - Mail Transfer Agents", slug: "communication---email---mail-transfer-agents", icon: "📨" },
  { label: "Communication - Email - Mailing Lists and Newsletters", slug: "communication---email---mailing-lists-and-newsletters", icon: "📧" },
  { label: "Communication - Email - Webmail Clients", slug: "communication---email---webmail-clients", icon: "🖥️" },
  { label: "Communication - IRC", slug: "communication---irc", icon: "🗨️" },
  { label: "Communication - SIP", slug: "communication---sip", icon: "📞" },
  { label: "Communication - Social Networks and Forums", slug: "communication---social-networks-and-forums", icon: "👥" },
  { label: "Communication - Video Conferencing", slug: "communication---video-conferencing", icon: "📹" },
  { label: "Communication - XMPP - Servers", slug: "communication---xmpp---servers", icon: "🔌" },
  { label: "Communication - XMPP - Web Clients", slug: "communication---xmpp---web-clients", icon: "💻" },
  { label: "Community-Supported Agriculture (CSA)", slug: "community-supported-agriculture-csa", icon: "🌱" },
  ...
  { label: "Customer Relationship Management (CRM)", slug: "customer-relationship-management-crm", icon: "💼" },
  ...
  { label: "Document Management - Institutional Repository and Digital Library Software", slug: "document-management---institutional-repository-and-digital-library-software", icon: "📚" },
  { label: "Document Management - Integrated Library Systems (ILS)", slug: "document-management---integrated-library-systems-ils", icon: "🏫" },
  { label: "E-commerce", slug: "e-commerce", icon: "🛍️" },
  { label: "Federated Identity & Authentication", slug: "federated-identity--authentication", icon: "🔑" },
  { label: "Feed Readers", slug: "feed-readers", icon: "📰" },
  { label: "File Transfer & Synchronization", slug: "file-transfer--synchronization", icon: "🔄" },
  { label: "File Transfer - Distributed Filesystems", slug: "file-transfer---distributed-filesystems", icon: "📁" },
  { label: "File Transfer - Object Storage & File Servers", slug: "file-transfer---object-storage--file-servers", icon: "🪣" },
  { label: "File Transfer - Peer-to-peer Filesharing", slug: "file-transfer---peer-to-peer-filesharing", icon: "🧲" },
  { label: "File Transfer - Single-click & Drag-n-drop Upload", slug: "file-transfer---single-click--drag-n-drop-upload", icon: "📤" },
  { label: "File Transfer - Web-based File Managers", slug: "file-transfer---web-based-file-managers", icon: "📂" },
  { label: "Games", slug: "games", icon: "🎮" },
  { label: "Games - Administrative Utilities & Control Panels", slug: "games---administrative-utilities--control-panels", icon: "🕹️" },
  { label: "Genealogy", slug: "genealogy", icon: "🌳" },
  { label: "Generative Artificial Intelligence (GenAI)", slug: "generative-artificial-intelligence-genai", icon: "🤖" },
  ...
  { label: "Maps and Global Positioning System (GPS)", slug: "maps-and-global-positioning-system-gps", icon: "🗺️" },
  { label: "Media Management", slug: "media-management", icon: "🎬" },
  { label: "Media Streaming", slug: "media-streaming", icon: "📺" },
  { label: "Media Streaming - Audio Streaming", slug: "media-streaming---audio-streaming", icon: "🎵" },
  { label: "Media Streaming - Multimedia Streaming", slug: "media-streaming---multimedia-streaming", icon: "📽️" },
  { label: "Media Streaming - Video Streaming", slug: "media-streaming---video-streaming", icon: "🍿" },
  ...
  { label: "Software Development - API Management", slug: "software-development---api-management", icon: "🔌" },
  { label: "Software Development - Continuous Integration & Deployment", slug: "software-development---continuous-integration--deployment", icon: "🚀" },
  { label: "Software Development - FaaS & Serverless", slug: "software-development---faas--serverless", icon: "⚡" },
  { label: "Software Development - Feature Toggle", slug: "software-development---feature-toggle", icon: "🎛️" },
  { label: "Software Development - IDE & Tools", slug: "software-development---ide--tools", icon: "🛠️" },
  { label: "Software Development - Localization", slug: "software-development---localization", icon: "🌐" },
  { label: "Software Development - Low Code", slug: "software-development---low-code", icon: "🧱" },
  { label: "Software Development - Project Management", slug: "software-development---project-management", icon: "📋" },
...
for (let i = 0; i < lines.length; i++) {
  ...
  if (line.startsWith('## ') || line.startsWith('### ')) {
    ...
    if (
      ...
      const match =
        TAG_LOOKUP.get(rawHeading.toLowerCase()) ||
    ...
    if (match && currentTagObj) {
      ...
      let desc = rest.replace(/^[-–—:]\s*/, '').replace(/\s*\([^)]*\)$/, '').trim();
...
fs.writeFileSync('hosterax/engine/src/awesome-selfhosted-db.json', JSON.stringify(outData, null, 2), 'utf8');
